...
@section('PageName', 'ModifyProgram')
            ...
            <form id="form" method="post" class="form-horizontal" >
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" maxlength="22" class="form-control" id="title" placeholder="Nombre" name="nombrePrograma" value="{!! $programa->nombre !!}" required="required">
                        </div>
                    </div>
                    <div class="form-group">
