...
@section('main-content')
    <legend>Crear una nueva clase</legend>


    <form id="regForm"  method="post" class="form-horizontal" enctype="multipart/form-data">


        <div class="tab" id="numSecciones"> <a href="#" class="help" data-toggle="tooltip" title="Añadir la información principal de la clase que incluye la minuiatura que verán los usuarios en la lista de ejercicios, el nombre y una pequeña introducción a modo de resumen de la misma." data-placement="right">
                <legend>Información general:</legend></a>
            <p><label for="title" class="control-label"><li>Miniatura:</li></label></p>
            <p><div class="image-upload">
                <label for="miniatura">
                    <img class="miniatura" id="output" title="Introduce la miniatura representativa de la clase"  height="100px" src=""/>
                </label>
                <input type="file" name="miniatura" id="miniatura" style ="display:none;" onchange="loadFile(event)"/>
            </div></p>
            <p><input type="text" maxlength="22" placeholder="Nombre..." class="form-control" placeholder="Nombre" name="nombreEjercicio" id="nombreEjercicio" value=""></p>
            <p><textarea class="form-control" placeholder="Introducción..." rows="3" id="introduccionEjercicio" name="introduccionEjercicio"></textarea></p>
        </div>
        ...
        <div class="tab" ><a href="#" class="help" data-toggle="tooltip" title="Selecciona el número de secciones que se desea que tenga el ejercicio" data-placement="right">
                <legend>Número secciones:</legend></a>
            <p><input class="form-control " onchange="dibujarSecciones();" type="number" name="numeroSecciones" id="numeroSecciones" value="" min="1" max="50" required></p>

        </div>
        <p id="seccion"></p>


        <div class="tab"><a href="#" class="help" data-toggle="tooltip" title="Añade las distintas opciones para la opinión final del usuario. Esto determina como se ha realizado la clase en función de la opción elegida que irán de peor a mejor." data-placement="right">
                <legend>Número de opciones respuesta final (de peor a mejor):</legend></a>
            <!--Se solicita el número de opciones de la respuesta final-->

            <p> <input class="form-control" onchange="dibujarPreguntas();" type="number" name="numeroOpciones" id="numeroOpciones" value="" min="1" max="6" required>
            </p>
    ...
    <script>
        ...
        function dibujarSecciones() {
            if(numSecciones!=(document.getElementById("numeroSecciones").value))
            {
                ...
                /* var nuevaSeccion = document.createElement('div');
                 nuevaSeccion.innerHTML=secciones;
                 var form = document.getElementById("regForm");
                 var numseccion = document.getElementById("numSecciones");
                 form.insertBefore(nuevaSeccion, form.childNodes[4]);*/
                //document.getElementById("seccion").innerHTML =secciones;
            ...
            if(el.style.border!="3px solid blue") {
                ...
                if (res[1] == 0) {
                    ...
                    document.getElementById(id).innerHTML = '<div class="form-group">\
                                    ...
                                    <source src="" id="file_' + idSeccion + '_' + posAccion + '" name="file?' + idSeccion + '&' + posAccion + '">\
        ...
        function addInstruccion(idSeccion, posAccion){
            ...
            var nuevaPosInstruccion = seccionesTotales[i].acciones[j].instrucciones.length + 1;
